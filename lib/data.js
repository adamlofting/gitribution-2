    ...
    if (err) {
      ...
      async.parallel({
          last_year: function (callback) {
            ...
            console.log('query_last_year');
            connection.query(sql, values,
              function queryComplete(err, result) {
                if (err) {
                  console.log(err);
                }
                console.log('query_last_year_complete');
          ...
          last_week: function (callback) {
            ...
            console.log('query_last_week');
            connection.query(sql, values,
              function queryComplete(err, result) {
                if (err) {
                  console.log(err);
                }
                console.log('query_last_week_complete');
                callback(null, result);
              });
          },
          last_year_excluding_last_week: function (callback) {
            ...
            console.log('query_last_year_excluding_week');
            connection.query(sql, values,
              function queryComplete(err, result) {
                if (err) {
                  console.log(err);
                }
                console.log('query_last_year_excluding_week_complete');
                callback(null, result);
              }
            );
          }
